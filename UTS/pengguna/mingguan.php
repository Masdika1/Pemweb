            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Aktivitas Mingguan </h1>
                        <br>
                        <div class="row">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class = "table-responsive">
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            $no = 1;
                                            $tampil = mysqli_query($conn, "SELECT * FROM mingguan ORDER BY idmingguan DESC");
                                                    ...
                                                    <td class="text-center">
                                                        <?php
                                                            if ($data['status'] == "Selesai") {
                                                                echo '<p><a href="smingguan.php?idmingguan=' . $data['idmingguan'] . '&status=0" class="btn btn-success">Selesai</a></p>';
                                                            } else {
                                                                echo '<p><a href="smingguan.php?idmingguan=' . $data['idmingguan'] . '&status=1" class="btn btn-danger">Belum Selesai</a></p>';
                                                            }
                                                        ?>
                                                    </td>
                                                    <td class="text-center"> 
                                                ...
                                                <div class="modal fade" id="modalUbah<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST" action="umingguan.php">
                                                                <input type="hidden" name="idmingguan" value="<?= $data['idmingguan']?>">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-select" name="thari">
                                                ...
                                                <div class="modal fade" id="modalHapus<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST" action="hmingguan.php">
                                                                <input type="hidden" name="idmingguan" value="<?= $data['idmingguan']?>">
                                    ...
                                    <div class="modal fade" id="modalTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" action="tmingguan.php">
                                                    <div class="modal-body">
